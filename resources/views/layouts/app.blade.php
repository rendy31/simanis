...
<head>
    ...
    <link rel="shortcut icon" href="https://stikessuakainsan.ac.id/wp-content/uploads/2022/11/KAMPUS-SUAKA-INSAN.png"
        type="image/x-icon">
    <title>SIManis</title>
...
<body class="bg-soft-blue">
    <nav class="navbar navbar-expand-lg bg-white py-3">
        <div class="container">
            <a href="." class="navbar-brand d-flex align-items-center gap-2 fw-bold">
                <img src="https://stikessuakainsan.ac.id/wp-content/uploads/2022/11/KAMPUS-SUAKA-INSAN.png"
                    width="40" alt="">
                <div>
            ...
            <div class="collapse navbar-collapse" id="navbarMenu">
                <ul class="navbar-nav mx-auto gap-3">
                    ...
                    <li wire:click class="nav-item dropdown">
                        <a href="#"
                            class="nav-link dropdown-toggle {{ Request::routeIs('gedung.*') || Request::routeIs('ruangan.*') ? 'active' : '' }}"
                            data-bs-toggle="dropdown">
                            <i class='bx bx-building'></i> Bangunan
                        </a>

                        <ul class="dropdown-menu mt-2">
                            <li>
                                <a wire:navigate href="{{ route('gedung.index') }}" class="dropdown-item">
                                    <i class='bx bx-buildings'></i> Data Gedung
                                </a>
                            </li>
                            <li>
                                <a wire:navigate href="{{ route('ruangan.index') }}" class="dropdown-item">
                                    <i class='bx bx-building-house'></i> Data Ruangan
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-item dropdown">
                        <a href="#"
                            class="nav-link dropdown-toggle {{ Request::routeIs('kategori.*') || Request::routeIs('barang.*') || Request::routeIs('penempatan.*') ? 'active' : '' }}"
                            data-bs-toggle="dropdown">
                            <i class='bx bxs-report'></i> Inventarisasi
                        </a>

                        <ul class="dropdown-menu mt-2">
                            <li>
                                <a wire:navigate href="{{ route('kategori.index') }}" class="dropdown-item">
                                    <i class='bx bx-category-alt'></i> Data Kategori Barang
                                </a>
                            </li>
                            <li>
                                <a wire:navigate href="{{ route('barang.index') }}" class="dropdown-item">
                                    <i class='bx bx-package'></i> Data Barang
                                </a>
                            </li>
                            <li>
                                <a wire:navigate href="{{ route('penempatan.index') }}" class="dropdown-item">
                                    <i class='bx bx-map-pin'></i> Penempatan Barang
                                </a>
                            </li>
                        </ul>
    ...
    <script data-navigate-once src="https://code.jquery.com/jquery-3.7.1.js"></script>
